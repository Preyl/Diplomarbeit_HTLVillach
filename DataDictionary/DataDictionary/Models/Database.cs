...
namespace DataDictionary.Models
{
    public static class Database
    {
        ...
        public static string ConnectionString = "Server = (localdb)\\MSSQLLocalDB; Database = Diplomarbeit; Trusted_Connection = true";
        ...
        public static List<string> ListData(string tablename, string columnname)
        {
